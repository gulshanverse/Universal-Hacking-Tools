...
> Identify expected and unexpected application paths in a controlled scope.

## Overview

Identify expected and unexpected application paths in a controlled scope. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
HTTP, HTTP Requests, Attack Surface
