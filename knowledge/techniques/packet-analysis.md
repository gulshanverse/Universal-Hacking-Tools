...
> Inspect packet captures to understand protocol behavior and evidence.

## Overview

Inspect packet captures to understand protocol behavior and evidence. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
Networking, TCP/IP, TCP, UDP, Security Monitoring
