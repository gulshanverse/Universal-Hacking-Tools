...
> Observe behavior in an isolated, controlled environment.

## Overview

Observe behavior in an isolated, controlled environment. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
EDR, Endpoint Detection, Secure Logging
