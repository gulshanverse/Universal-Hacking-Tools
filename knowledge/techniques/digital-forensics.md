...
> Preserve and interpret artifacts to answer a defined investigative question.

## Overview

Preserve and interpret artifacts to answer a defined investigative question. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
autopsy, volatility3, exiftool

## Technologies

Security Monitoring, Attack Surface
