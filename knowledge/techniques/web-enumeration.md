...
> Map routes, methods, parameters, and application surfaces in an authorized application.

## Overview

Map routes, methods, parameters, and application surfaces in an authorized application. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
owasp-zap, burp-suite, ffuf

## Technologies

HTTP, HTTP Requests, HTTP Responses, Attack Surface
...
Security Headers, Secure Logging
