...
> Find public or internal names that belong to an authorized domain inventory.

## Overview

Find public or internal names that belong to an authorized domain inventory. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
