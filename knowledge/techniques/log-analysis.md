...
> Extract evidence and patterns from security-relevant records.

## Overview

Extract evidence and patterns from security-relevant records. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
Security Monitoring, Authentication, HTTP Responses
