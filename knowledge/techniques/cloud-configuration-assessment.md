---
id: cloud-configuration-assessment
type: technique
...
> Review cloud identity, storage, network, logging, and workload settings against policy.

## Overview

Review cloud identity, storage, network, logging, and workload settings against policy. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
Attack Surface, Authorization, Access Control, Vulnerability Management
...
Least Privilege, Secure Configuration, Secure Logging
