...
> Measure the exposure and reachability of approved network assets.

## Overview

Measure the exposure and reachability of approved network assets. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
Networking, TCP/IP, Ports, Services
