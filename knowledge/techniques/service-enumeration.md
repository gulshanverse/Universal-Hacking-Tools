...
> Identify and characterize services within an approved scope.

## Overview

Identify and characterize services within an approved scope. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
