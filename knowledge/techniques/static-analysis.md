...
> Inspect code, files, or binaries without executing the subject artifact.

## Overview

Inspect code, files, or binaries without executing the subject artifact. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
Secure Configuration, Endpoint Detection
