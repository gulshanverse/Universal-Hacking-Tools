...
> Interpret network flows and protocol signals for troubleshooting or defense.

## Overview

Interpret network flows and protocol signals for troubleshooting or defense. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
Networking, TCP/IP, Security Monitoring
