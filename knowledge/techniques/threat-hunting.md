...
> Form and test hypotheses against security telemetry.

## Overview

Form and test hypotheses against security telemetry. Use it only to answer a defined security question in an owned, local, CTF, synthetic, or explicitly authorized environment.
...
wazuh, osquery, zeek, sigma

## Technologies

Security Monitoring, Attack Surface, Authentication
...
Secure Logging, EDR, Endpoint Detection
