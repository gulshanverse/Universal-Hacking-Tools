...
> A mechanism that translates address or port information across a network boundary.

## Overview

A mechanism that translates address or port information across a network boundary. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc3022)
