...
> A protocol for authenticated, confidential, and integrity-protected communication.

## Overview

A protocol for authenticated, confidential, and integrity-protected communication. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc8446)
