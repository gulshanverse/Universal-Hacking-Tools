...
> Operating-system identity groupings used to assign ownership and access.

## Overview

Operating-system identity groupings used to assign ownership and access. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/identity)
