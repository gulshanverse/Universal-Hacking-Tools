...
> The decision process that determines what an authenticated principal may do.

## Overview

The decision process that determines what an authenticated principal may do. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/authorization)
