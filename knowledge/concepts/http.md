...
> The application protocol used to transfer web resources and API messages.

## Overview

The application protocol used to transfer web resources and API messages. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
