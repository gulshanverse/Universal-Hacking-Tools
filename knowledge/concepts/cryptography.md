...
> The discipline of designing and using mechanisms for confidentiality, integrity, authentication, and non-repudiation.

## Overview

The discipline of designing and using mechanisms for confidentiality, integrity, authentication, and non-repudiation. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
* [Authoritative source](https://csrc.nist.gov/cryptography)
