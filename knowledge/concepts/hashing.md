...
> Mapping input data to a fixed-size digest for integrity, lookup, or password-storage designs.

## Overview

Mapping input data to a fixed-size digest for integrity, lookup, or password-storage designs. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/hash_function)
