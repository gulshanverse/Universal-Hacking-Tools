...
> A protocol for dynamically configuring hosts with network parameters.

## Overview

A protocol for dynamically configuring hosts with network parameters. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc2131)
