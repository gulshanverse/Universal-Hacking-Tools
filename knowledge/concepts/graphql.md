...
> A query language and execution model for APIs with client-selected fields.

## Overview

A query language and execution model for APIs with client-selected fields. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://graphql.org/learn/)
