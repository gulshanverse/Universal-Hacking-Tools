...
sources:
  - https://csrc.nist.gov/glossary/term/memory
---

# Memory

> Volatile storage used by running programs and operating-system components.

## Overview

Volatile storage used by running programs and operating-system components. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/memory)
