...
The distributed naming system that maps domain names to resource records. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
[DNS Enumeration](../techniques/dns-enumeration.md), [Subdomain Discovery](../techniques/subdomain-discovery.md)
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc1034)
