...
> A method for labeling information so handling and protection match sensitivity.

## Overview

A method for labeling information so handling and protection match sensitivity. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/data_classification)
