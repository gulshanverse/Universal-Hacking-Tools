...
> Server messages that communicate status, headers, and optional content to an HTTP client.

## Overview

Server messages that communicate status, headers, and optional content to an HTTP client. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
[Web Enumeration](../techniques/web-enumeration.md), [Log Analysis](../techniques/log-analysis.md)
