...
> The generation and evaluation of unpredictable values used in security mechanisms.

## Overview

The generation and evaluation of unpredictable values used in security mechanisms. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/pubs/sp/800/90a/r1/final)
