...
> Interfaces through which programs request operating-system services.

## Overview

Interfaces through which programs request operating-system services. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://man7.org/linux/man-pages/man2/syscalls.2.html)
