...
> Policy enforcement points that control traffic between trust zones.

## Overview

Policy enforcement points that control traffic between trust zones. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/firewall)
