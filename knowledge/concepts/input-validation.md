...
> The process of checking untrusted input against an explicit, context-appropriate contract.

## Overview

The process of checking untrusted input against an explicit, context-appropriate contract. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
[Security Testing](../techniques/security-testing.md)
...
* [Authoritative source](https://cwe.mitre.org/data/definitions/20.html)
