...
Granting only the access required for a task, identity, process, or workload. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/least_privilege)
