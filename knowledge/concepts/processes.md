...
> Operating-system execution units with identity, resources, and observable lifecycle events.

## Overview

Operating-system execution units with identity, resources, and observable lifecycle events. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://man7.org/linux/man-pages/man5/proc.5.html)
