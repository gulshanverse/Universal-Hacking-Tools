...
> Server- or client-associated state used to maintain continuity across related requests.

## Overview

Server- or client-associated state used to maintain continuity across related requests. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
* [Authoritative source](https://owasp.org/www-project-web-security-testing-guide/)
