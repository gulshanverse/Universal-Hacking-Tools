...
> A connectionless transport protocol that provides datagrams without TCP-style delivery guarantees.

## Overview

A connectionless transport protocol that provides datagrams without TCP-style delivery guarantees. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
[Packet Analysis](../techniques/packet-analysis.md)
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc768)
