...
> Cryptographic evidence used to support integrity and signer authentication.

## Overview

Cryptographic evidence used to support integrity and signer authentication. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/digital_signature)
