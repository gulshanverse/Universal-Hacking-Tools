...
> Forwarding frames within a local network using link-layer information.

## Overview

Forwarding frames within a local network using link-layer information. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://www.ieee802.org/1/)
