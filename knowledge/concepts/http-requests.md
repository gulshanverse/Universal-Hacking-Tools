...
> Client messages that identify a method, target, headers, and optional content for an HTTP operation.

## Overview

Client messages that identify a method, target, headers, and optional content for an HTTP operation. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
...
[Web Enumeration](../techniques/web-enumeration.md), [Content Discovery](../techniques/content-discovery.md)
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc9110)
