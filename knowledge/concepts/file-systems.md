...
> Structures and rules for storing, naming, protecting, and recovering files.

## Overview

Structures and rules for storing, naming, protecting, and recovering files. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/file_system)
