...
> A security approach that continuously evaluates access instead of trusting network location alone.

## Overview

A security approach that continuously evaluates access instead of trusting network location alone. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
