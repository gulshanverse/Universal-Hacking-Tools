...
> Rules that govern which principals or processes may access resources.

## Overview

Rules that govern which principals or processes may access resources. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://csrc.nist.gov/glossary/term/permission)
