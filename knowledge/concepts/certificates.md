...
> Signed data structures that bind identities or attributes to public keys.

## Overview

Signed data structures that bind identities or attributes to public keys. This page provides a concise foundation for connecting concepts to techniques, tools, technologies, labs, and controls.
...
* [Authoritative source](https://www.rfc-editor.org/rfc/rfc5280)
