...
> Network or local processes that expose capabilities through defined interfaces.

## Overview

Network or local processes that expose capabilities through defined interfaces. This page is part of the Phase 2 knowledge graph and is intentionally concise enough to remain maintainable in GitHub Markdown.
