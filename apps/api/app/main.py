...
app.add_middleware(CORSMiddleware, allow_origins=allowed_origins, allow_credentials=False, allow_methods=["GET", "POST", "DELETE"], allow_headers=["Content-Type", "X-Lab-Session"])
...
async def http_error(_: Request, exc: HTTPException):
    status_to_code = {404: "ENTITY_NOT_FOUND", 409: "INVALID_LAB_STATE", 422: "INVALID_PARAMETER"}
