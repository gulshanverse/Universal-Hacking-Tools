...
official_website: https://google.github.io/osv-scanner/
documentation: https://google.github.io/osv-scanner/
security_domains: [Secure Development, Dependency scanning]
dual_use: true
...
sources:
  official_repository: https://github.com/google/osv-scanner
  official_website: https://google.github.io/osv-scanner/
  official_documentation: https://google.github.io/osv-scanner/
status: Verify against upstream documentation.
---

# OSV-Scanner

> Open-source dependency vulnerability scanning. This page is written for lawful, authorized security education.

## Overview

**OSV-Scanner** is used for matching project dependencies to the osv vulnerability database and supporting remediation. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Secure Development |
| Subcategory | Dependency scanning |
| Primary purpose | Open-source dependency vulnerability scanning |
| License | Apache-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Go |
| Repository | [OSV-Scanner repository](https://github.com/google/osv-scanner) |
| Official website | [https://google.github.io/osv-scanner/](https://google.github.io/osv-scanner/) |
| Documentation | [https://google.github.io/osv-scanner/](https://google.github.io/osv-scanner/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Beginner |
| Security domain | Secure Development; Dependency scanning |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use OSV-Scanner when the assessment question matches **open-source dependency vulnerability scanning**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Matching project dependencies to the OSV vulnerability database and supporting remediation.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[OSV-Scanner]
...
* Focused workflow for open-source dependency vulnerability scanning.
...
OSV-Scanner cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| Dependabot | Complementary analysis | Verify upstream | Verify upstream |
| Grype | Validation or defense | Verify upstream | Verify upstream |
...
Use OSV-Scanner when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [OSV-Scanner official repository](https://github.com/google/osv-scanner)
2. [OSV-Scanner official website](https://google.github.io/osv-scanner/)
3. [OSV-Scanner official documentation](https://google.github.io/osv-scanner/)
