...
security_domains: [OSINT, OSINT framework]
dual_use: true
...
sources:
  official_repository: https://github.com/lanmaster53/recon-ng
  official_website: https://github.com/lanmaster53/recon-ng
  official_documentation: https://github.com/lanmaster53/recon-ng/wiki
status: Verify against upstream documentation.
---

# Recon-ng

> Modular reconnaissance workflow. This page is written for lawful, authorized security education.

## Overview

**Recon-ng** is used for a modular workspace for organizing passive reconnaissance and documenting collection provenance. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | OSINT |
| Subcategory | OSINT framework |
| Primary purpose | Modular reconnaissance workflow |
| License | GPL-3.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; macOS |
| Language | Python |
| Repository | [Recon-ng repository](https://github.com/lanmaster53/recon-ng) |
| Official website | [https://github.com/lanmaster53/recon-ng](https://github.com/lanmaster53/recon-ng) |
| Documentation | [https://github.com/lanmaster53/recon-ng/wiki](https://github.com/lanmaster53/recon-ng/wiki) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | OSINT; OSINT framework |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Recon-ng when the assessment question matches **modular reconnaissance workflow**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* A modular workspace for organizing passive reconnaissance and documenting collection provenance.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Recon-ng]
...
* Focused workflow for modular reconnaissance workflow.
...
Recon-ng cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| SpiderFoot | A related workflow or comparison point | Verify upstream | Verify upstream |
| theHarvester | Complementary analysis | Verify upstream | Verify upstream |
| Amass | Validation or defense | Verify upstream | Verify upstream |
...
Use Recon-ng when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Recon-ng official repository](https://github.com/lanmaster53/recon-ng)
2. [Recon-ng official website](https://github.com/lanmaster53/recon-ng)
3. [Recon-ng official documentation](https://github.com/lanmaster53/recon-ng/wiki)
