...
subcategory: Password auditing
difficulty: Advanced
license: MIT
platforms: [Linux; Windows; macOS]
language: C
repository: https://github.com/hashcat/hashcat
official_website: https://hashcat.net/hashcat/
...
sources:
  official_repository: https://github.com/hashcat/hashcat
  official_website: https://hashcat.net/hashcat/
  official_documentation: https://hashcat.net/wiki/
status: Verify against upstream documentation.
---

# Hashcat

> Offline password-strength auditing. This page is written for lawful, authorized security education.

## Overview

**Hashcat** is used for measuring password resilience only with owned or explicitly authorized hashes and documented approval. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Password Security |
| Subcategory | Password auditing |
| Primary purpose | Offline password-strength auditing |
| License | MIT |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | C |
| Repository | [Hashcat repository](https://github.com/hashcat/hashcat) |
| Official website | [https://hashcat.net/hashcat/](https://hashcat.net/hashcat/) |
| Documentation | [https://hashcat.net/wiki/](https://hashcat.net/wiki/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Advanced |
| Security domain | Password Security; Password auditing |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Hashcat when the assessment question matches **offline password-strength auditing**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Measuring password resilience only with owned or explicitly authorized hashes and documented approval.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Hashcat]
...
* Focused workflow for offline password-strength auditing.
...
Hashcat cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| John the Ripper | A related workflow or comparison point | Verify upstream | Verify upstream |
| L0phtCrack | Complementary analysis | Verify upstream | Verify upstream |
| password policy testing | Validation or defense | Verify upstream | Verify upstream |
...
Use Hashcat when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Hashcat official repository](https://github.com/hashcat/hashcat)
2. [Hashcat official website](https://hashcat.net/hashcat/)
3. [Hashcat official documentation](https://hashcat.net/wiki/)
