...
| Category | Password Security |
| Subcategory | Password auditing |
| Primary purpose | Password-strength auditing |
| License | GPL-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | C |
| Repository | [John the Ripper repository](https://github.com/openwall/john) |
| Official website | [https://www.openwall.com/john/](https://www.openwall.com/john/) |
| Documentation | [https://www.openwall.com/john/](https://www.openwall.com/john/) |
...
Use John the Ripper when the assessment question matches **password-strength auditing**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Offline auditing of test credentials to inform password policy and defensive controls.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[John the Ripper]
...
* Focused workflow for password-strength auditing.
...
John the Ripper cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Hashcat | A related workflow or comparison point | Verify upstream | Verify upstream |
| password managers | Complementary analysis | Verify upstream | Verify upstream |
| breach monitoring | Validation or defense | Verify upstream | Verify upstream |
...
Use John the Ripper when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [John the Ripper official repository](https://github.com/openwall/john)
2. [John the Ripper official website](https://www.openwall.com/john/)
3. [John the Ripper official documentation](https://www.openwall.com/john/)
