...
subcategory: Template-based assessment
difficulty: Intermediate
license: MIT
platforms: [Linux; Windows; macOS]
language: Go
repository: https://github.com/projectdiscovery/nuclei
official_website: https://projectdiscovery.io/opensource/nuclei
documentation: https://docs.projectdiscovery.io/tools/nuclei/overview
security_domains: [Web Security, Template-based assessment]
dual_use: true
...
sources:
  official_repository: https://github.com/projectdiscovery/nuclei
  official_website: https://projectdiscovery.io/opensource/nuclei
  official_documentation: https://docs.projectdiscovery.io/tools/nuclei/overview
status: Verify against upstream documentation.
---

# Nuclei

> Repeatable vulnerability checks. This page is written for lawful, authorized security education.

## Overview

**Nuclei** is used for running reviewed templates against an approved inventory with careful severity and rate controls. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Web Security |
| Subcategory | Template-based assessment |
| Primary purpose | Repeatable vulnerability checks |
| License | MIT |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Go |
| Repository | [Nuclei repository](https://github.com/projectdiscovery/nuclei) |
| Official website | [https://projectdiscovery.io/opensource/nuclei](https://projectdiscovery.io/opensource/nuclei) |
| Documentation | [https://docs.projectdiscovery.io/tools/nuclei/overview](https://docs.projectdiscovery.io/tools/nuclei/overview) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Web Security; Template-based assessment |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Nuclei when the assessment question matches **repeatable vulnerability checks**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Running reviewed templates against an approved inventory with careful severity and rate controls.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Nuclei]
...
* Focused workflow for repeatable vulnerability checks.
...
Nuclei cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| Nikto | Complementary analysis | Verify upstream | Verify upstream |
| Greenbone | Validation or defense | Verify upstream | Verify upstream |
...
Use Nuclei when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Nuclei official repository](https://github.com/projectdiscovery/nuclei)
2. [Nuclei official website](https://projectdiscovery.io/opensource/nuclei)
3. [Nuclei official documentation](https://docs.projectdiscovery.io/tools/nuclei/overview)
