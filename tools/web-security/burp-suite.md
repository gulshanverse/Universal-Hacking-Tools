...
subcategory: Web application proxy
difficulty: Beginner
license: Proprietary; verify upstream terms
platforms: [Linux; Windows; macOS]
language: Java
repository: https://portswigger.net/burp
official_website: https://portswigger.net/burp
documentation: https://portswigger.net/burp/documentation
security_domains: [Web Security, Web application proxy]
dual_use: true
...
sources:
  official_repository: https://portswigger.net/burp
  official_website: https://portswigger.net/burp
  official_documentation: https://portswigger.net/burp/documentation
status: Verify against upstream documentation.
---

# Burp Suite

> Web security assessment platform. This page is written for lawful, authorized security education.

## Overview

**Burp Suite** is used for manual http analysis, repeater workflows, and authorized testing with edition-specific capabilities. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Web Security |
| Subcategory | Web application proxy |
| Primary purpose | Web security assessment platform |
| License | Proprietary; verify upstream terms |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Java |
| Repository | [Burp Suite repository](https://portswigger.net/burp) |
| Official website | [https://portswigger.net/burp](https://portswigger.net/burp) |
| Documentation | [https://portswigger.net/burp/documentation](https://portswigger.net/burp/documentation) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Beginner |
| Security domain | Web Security; Web application proxy |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Burp Suite when the assessment question matches **web security assessment platform**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Manual HTTP analysis, repeater workflows, and authorized testing with edition-specific capabilities.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Burp Suite]
...
* Focused workflow for web security assessment platform.
...
Burp Suite cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| mitmproxy | Complementary analysis | Verify upstream | Verify upstream |
| Caido | Validation or defense | Verify upstream | Verify upstream |
...
Use Burp Suite when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Burp Suite official repository](https://portswigger.net/burp)
2. [Burp Suite official website](https://portswigger.net/burp)
3. [Burp Suite official documentation](https://portswigger.net/burp/documentation)
