...
official_website: https://github.com/ffuf/ffuf
documentation: https://github.com/ffuf/ffuf/wiki
security_domains: [Web Security, Content discovery]
dual_use: true
...
sources:
  official_repository: https://github.com/ffuf/ffuf
  official_website: https://github.com/ffuf/ffuf
  official_documentation: https://github.com/ffuf/ffuf/wiki
status: Verify against upstream documentation.
---

# ffuf

> Web content discovery. This page is written for lawful, authorized security education.

## Overview

**ffuf** is used for testing routes in a local lab or approved application while minimizing load and preserving evidence. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Web Security |
| Subcategory | Content discovery |
| Primary purpose | Web content discovery |
| License | MIT |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Go |
| Repository | [ffuf repository](https://github.com/ffuf/ffuf) |
| Official website | [https://github.com/ffuf/ffuf](https://github.com/ffuf/ffuf) |
| Documentation | [https://github.com/ffuf/ffuf/wiki](https://github.com/ffuf/ffuf/wiki) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Web Security; Content discovery |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use ffuf when the assessment question matches **web content discovery**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Testing routes in a local lab or approved application while minimizing load and preserving evidence.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[ffuf]
...
* Focused workflow for web content discovery.
...
ffuf cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Gobuster | A related workflow or comparison point | Verify upstream | Verify upstream |
| feroxbuster | Complementary analysis | Verify upstream | Verify upstream |
| OWASP ZAP | Validation or defense | Verify upstream | Verify upstream |
...
Use ffuf when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [ffuf official repository](https://github.com/ffuf/ffuf)
2. [ffuf official website](https://github.com/ffuf/ffuf)
3. [ffuf official documentation](https://github.com/ffuf/ffuf/wiki)
