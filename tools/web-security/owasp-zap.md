...
official_website: https://www.zaproxy.org/
...
sources:
  official_repository: https://github.com/zaproxy/zaproxy
  official_website: https://www.zaproxy.org/
  official_documentation: https://www.zaproxy.org/docs/
status: Verify against upstream documentation.
---

# OWASP ZAP

> Web application security testing. This page is written for lawful, authorized security education.

## Overview

**OWASP ZAP** is used for intercepting and analyzing http(s) traffic, crawling an authorized application, and recording evidence. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Web Security |
| Subcategory | Web application proxy |
| Primary purpose | Web application security testing |
| License | Apache-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Java |
| Repository | [OWASP ZAP repository](https://github.com/zaproxy/zaproxy) |
...
Use OWASP ZAP when the assessment question matches **web application security testing**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Intercepting and analyzing HTTP(S) traffic, crawling an authorized application, and recording evidence.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[OWASP ZAP]
...
* Focused workflow for web application security testing.
...
OWASP ZAP cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Burp Suite | A related workflow or comparison point | Verify upstream | Verify upstream |
...
Use OWASP ZAP when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [OWASP ZAP official repository](https://github.com/zaproxy/zaproxy)
2. [OWASP ZAP official website](https://www.zaproxy.org/)
3. [OWASP ZAP official documentation](https://www.zaproxy.org/docs/)
