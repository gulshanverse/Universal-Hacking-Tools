...
subcategory: Content and DNS discovery
difficulty: Beginner
license: Apache-2.0
platforms: [Linux; Windows; macOS]
language: Go
repository: https://github.com/OJ/gobuster
official_website: https://github.com/OJ/gobuster
documentation: https://github.com/OJ/gobuster#readme
security_domains: [Web Security, Content and DNS discovery]
dual_use: true
...
sources:
  official_repository: https://github.com/OJ/gobuster
  official_website: https://github.com/OJ/gobuster
  official_documentation: https://github.com/OJ/gobuster#readme
status: Verify against upstream documentation.
---

# Gobuster

> Directory and DNS enumeration. This page is written for lawful, authorized security education.

## Overview

**Gobuster** is used for wordlist-based discovery in explicitly authorized environments with conservative request rates. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Web Security |
| Subcategory | Content and DNS discovery |
| Primary purpose | Directory and DNS enumeration |
| License | Apache-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Go |
| Repository | [Gobuster repository](https://github.com/OJ/gobuster) |
| Official website | [https://github.com/OJ/gobuster](https://github.com/OJ/gobuster) |
| Documentation | [https://github.com/OJ/gobuster#readme](https://github.com/OJ/gobuster#readme) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Beginner |
| Security domain | Web Security; Content and DNS discovery |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Gobuster when the assessment question matches **directory and dns enumeration**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Wordlist-based discovery in explicitly authorized environments with conservative request rates.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Gobuster]
...
* Focused workflow for directory and dns enumeration.
...
Gobuster cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| ffuf | A related workflow or comparison point | Verify upstream | Verify upstream |
| feroxbuster | Complementary analysis | Verify upstream | Verify upstream |
| Subfinder | Validation or defense | Verify upstream | Verify upstream |
...
Use Gobuster when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Gobuster official repository](https://github.com/OJ/gobuster)
2. [Gobuster official website](https://github.com/OJ/gobuster)
3. [Gobuster official documentation](https://github.com/OJ/gobuster#readme)
