...
official_website: https://www.kismetwireless.net/
documentation: https://www.kismetwireless.net/docs/
security_domains: [Wireless Security, Wireless monitoring]
dual_use: true
...
sources:
  official_repository: https://github.com/kismetwireless/kismet
  official_website: https://www.kismetwireless.net/
  official_documentation: https://www.kismetwireless.net/docs/
status: Verify against upstream documentation.
---

# Kismet

> Wireless discovery and monitoring. This page is written for lawful, authorized security education.

## Overview

**Kismet** is used for passive wireless monitoring, inventory, and troubleshooting with appropriate privacy controls. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Wireless Security |
| Subcategory | Wireless monitoring |
| Primary purpose | Wireless discovery and monitoring |
| License | GPL-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; macOS |
| Language | C++; JavaScript |
| Repository | [Kismet repository](https://github.com/kismetwireless/kismet) |
| Official website | [https://www.kismetwireless.net/](https://www.kismetwireless.net/) |
| Documentation | [https://www.kismetwireless.net/docs/](https://www.kismetwireless.net/docs/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Wireless Security; Wireless monitoring |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Kismet when the assessment question matches **wireless discovery and monitoring**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Passive wireless monitoring, inventory, and troubleshooting with appropriate privacy controls.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Kismet]
...
* Focused workflow for wireless discovery and monitoring.
...
Kismet cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Aircrack-ng | A related workflow or comparison point | Verify upstream | Verify upstream |
| Wireshark | Complementary analysis | Verify upstream | Verify upstream |
| airodump-ng | Validation or defense | Verify upstream | Verify upstream |
...
Use Kismet when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Kismet official repository](https://github.com/kismetwireless/kismet)
2. [Kismet official website](https://www.kismetwireless.net/)
3. [Kismet official documentation](https://www.kismetwireless.net/docs/)
