...
security_domains: [Reconnaissance, Network scanning]
dual_use: true
...
sources:
  official_repository: https://github.com/nmap/nmap
  official_website: https://nmap.org/
  official_documentation: https://nmap.org/book/man.html
status: Verify against upstream documentation.
---

# Nmap

> Network discovery and service enumeration. This page is written for lawful, authorized security education.

## Overview

**Nmap** is used for host discovery, port scanning, service/version detection, and scripting in authorized environments. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Reconnaissance |
| Subcategory | Network scanning |
| Primary purpose | Network discovery and service enumeration |
| License | Nmap Public Source License |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | C/C++ |
| Repository | [Nmap repository](https://github.com/nmap/nmap) |
| Official website | [https://nmap.org/](https://nmap.org/) |
| Documentation | [https://nmap.org/book/man.html](https://nmap.org/book/man.html) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Beginner |
| Security domain | Reconnaissance; Network scanning |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Nmap when the assessment question matches **network discovery and service enumeration**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Host discovery, port scanning, service/version detection, and scripting in authorized environments.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Nmap]
...
* Focused workflow for network discovery and service enumeration.
...
Nmap cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Masscan | A related workflow or comparison point | Verify upstream | Verify upstream |
| RustScan | Complementary analysis | Verify upstream | Verify upstream |
| Naabu | Validation or defense | Verify upstream | Verify upstream |
...
Use Nmap when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Nmap official repository](https://github.com/nmap/nmap)
2. [Nmap official website](https://nmap.org/)
