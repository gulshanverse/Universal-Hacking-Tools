...
subcategory: OSINT reconnaissance
difficulty: Beginner
license: GPL-2.0
...
documentation: https://github.com/laramies/theHarvester#usage
security_domains: [Reconnaissance, OSINT reconnaissance]
dual_use: true
...
sources:
  official_repository: https://github.com/laramies/theHarvester
  official_website: https://github.com/laramies/theHarvester
  official_documentation: https://github.com/laramies/theHarvester#usage
status: Verify against upstream documentation.
---

# theHarvester

> Public-source reconnaissance. This page is written for lawful, authorized security education.

## Overview

**theHarvester** is used for collecting publicly available domain, host, and account clues for an approved assessment. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Reconnaissance |
| Subcategory | OSINT reconnaissance |
| Primary purpose | Public-source reconnaissance |
| License | GPL-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; macOS; Windows |
| Language | Python |
| Repository | [theHarvester repository](https://github.com/laramies/theHarvester) |
| Official website | [https://github.com/laramies/theHarvester](https://github.com/laramies/theHarvester) |
| Documentation | [https://github.com/laramies/theHarvester#usage](https://github.com/laramies/theHarvester#usage) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Beginner |
| Security domain | Reconnaissance; OSINT reconnaissance |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use theHarvester when the assessment question matches **public-source reconnaissance**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Collecting publicly available domain, host, and account clues for an approved assessment.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[theHarvester]
...
* Focused workflow for public-source reconnaissance.
...
theHarvester cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| Subfinder | Complementary analysis | Verify upstream | Verify upstream |
| SpiderFoot | Validation or defense | Verify upstream | Verify upstream |
...
Use theHarvester when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [theHarvester official repository](https://github.com/laramies/theHarvester)
2. [theHarvester official website](https://github.com/laramies/theHarvester)
3. [theHarvester official documentation](https://github.com/laramies/theHarvester#usage)
