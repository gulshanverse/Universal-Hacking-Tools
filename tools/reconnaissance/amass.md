...
subcategory: Attack surface discovery
difficulty: Intermediate
license: Apache-2.0
platforms: [Linux; Windows; macOS]
language: Go
repository: https://github.com/owasp-amass/amass
official_website: https://owasp.org/www-project-amass/
documentation: https://github.com/owasp-amass/amass#documentation
security_domains: [Reconnaissance, Attack surface discovery]
dual_use: true
...
sources:
  official_repository: https://github.com/owasp-amass/amass
  official_website: https://owasp.org/www-project-amass/
  official_documentation: https://github.com/owasp-amass/amass#documentation
status: Verify against upstream documentation.
---

# Amass

> External attack surface mapping. This page is written for lawful, authorized security education.

## Overview

**Amass** is used for asset discovery, dns enumeration, and relationship mapping for owned or authorized domains. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Reconnaissance |
| Subcategory | Attack surface discovery |
| Primary purpose | External attack surface mapping |
| License | Apache-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Go |
| Repository | [Amass repository](https://github.com/owasp-amass/amass) |
| Official website | [https://owasp.org/www-project-amass/](https://owasp.org/www-project-amass/) |
| Documentation | [https://github.com/owasp-amass/amass#documentation](https://github.com/owasp-amass/amass#documentation) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Reconnaissance; Attack surface discovery |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Amass when the assessment question matches **external attack surface mapping**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Asset discovery, DNS enumeration, and relationship mapping for owned or authorized domains.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Amass]
...
* Focused workflow for external attack surface mapping.
...
Amass cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Subfinder | A related workflow or comparison point | Verify upstream | Verify upstream |
...
Use Amass when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Amass official repository](https://github.com/owasp-amass/amass)
2. [Amass official website](https://owasp.org/www-project-amass/)
3. [Amass official documentation](https://github.com/owasp-amass/amass#documentation)
