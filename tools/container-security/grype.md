...
subcategory: Container vulnerability scanning
difficulty: Beginner
license: Apache-2.0
platforms: [Linux; Windows; macOS]
language: Go
repository: https://github.com/anchore/grype
official_website: https://github.com/anchore/grype
documentation: https://github.com/anchore/grype#readme
security_domains: [Container Security, Container vulnerability scanning]
dual_use: true
...
sources:
  official_repository: https://github.com/anchore/grype
  official_website: https://github.com/anchore/grype
  official_documentation: https://github.com/anchore/grype#readme
status: Verify against upstream documentation.
---

# Grype

> Image and filesystem vulnerability scanning. This page is written for lawful, authorized security education.

## Overview

**Grype** is used for matching packages in images or filesystems to vulnerability databases and triaging remediation. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Container Security |
| Subcategory | Container vulnerability scanning |
| Primary purpose | Image and filesystem vulnerability scanning |
| License | Apache-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Go |
| Repository | [Grype repository](https://github.com/anchore/grype) |
| Official website | [https://github.com/anchore/grype](https://github.com/anchore/grype) |
| Documentation | [https://github.com/anchore/grype#readme](https://github.com/anchore/grype#readme) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Beginner |
| Security domain | Container Security; Container vulnerability scanning |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Grype when the assessment question matches **image and filesystem vulnerability scanning**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Matching packages in images or filesystems to vulnerability databases and triaging remediation.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Grype]
...
* Focused workflow for image and filesystem vulnerability scanning.
...
Grype cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| Clair | Complementary analysis | Verify upstream | Verify upstream |
| OSV-Scanner | Validation or defense | Verify upstream | Verify upstream |
...
Use Grype when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Grype official repository](https://github.com/anchore/grype)
2. [Grype official website](https://github.com/anchore/grype)
3. [Grype official documentation](https://github.com/anchore/grype#readme)
