...
official_website: https://sigmahq.io/
documentation: https://sigmahq.io/docs/
security_domains: [Defensive Security, Detection engineering]
dual_use: true
...
sources:
  official_repository: https://github.com/SigmaHQ/sigma
  official_website: https://sigmahq.io/
  official_documentation: https://sigmahq.io/docs/
status: Verify against upstream documentation.
---

# Sigma

> Portable log detections. This page is written for lawful, authorized security education.

## Overview

**Sigma** is used for authoring vendor-neutral detection logic that can be converted for supported siems. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Defensive Security |
| Subcategory | Detection engineering |
| Primary purpose | Portable log detections |
| License | LGPL-2.1 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Platform independent |
| Language | Python; YAML |
| Repository | [Sigma repository](https://github.com/SigmaHQ/sigma) |
| Official website | [https://sigmahq.io/](https://sigmahq.io/) |
| Documentation | [https://sigmahq.io/docs/](https://sigmahq.io/docs/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Defensive Security; Detection engineering |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Sigma when the assessment question matches **portable log detections**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Authoring vendor-neutral detection logic that can be converted for supported SIEMs.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Sigma]
...
* Focused workflow for portable log detections.
...
Sigma cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| YARA | A related workflow or comparison point | Verify upstream | Verify upstream |
| KQL | Complementary analysis | Verify upstream | Verify upstream |
| Splunk SPL | Validation or defense | Verify upstream | Verify upstream |
...
Use Sigma when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Sigma official repository](https://github.com/SigmaHQ/sigma)
2. [Sigma official website](https://sigmahq.io/)
3. [Sigma official documentation](https://sigmahq.io/docs/)
