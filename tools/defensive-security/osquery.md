...
official_website: https://osquery.io/
documentation: https://osquery.readthedocs.io/
security_domains: [Defensive Security, Endpoint visibility]
dual_use: true
...
sources:
  official_repository: https://github.com/osquery/osquery
  official_website: https://osquery.io/
  official_documentation: https://osquery.readthedocs.io/
status: Verify against upstream documentation.
---

# osquery

> SQL-powered endpoint inventory. This page is written for lawful, authorized security education.

## Overview

**osquery** is used for querying endpoint state for asset inventory, compliance, and threat-hunting investigations. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Defensive Security |
| Subcategory | Endpoint visibility |
| Primary purpose | SQL-powered endpoint inventory |
| License | BSD-3-Clause |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | C++ |
| Repository | [osquery repository](https://github.com/osquery/osquery) |
| Official website | [https://osquery.io/](https://osquery.io/) |
| Documentation | [https://osquery.readthedocs.io/](https://osquery.readthedocs.io/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Defensive Security; Endpoint visibility |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use osquery when the assessment question matches **sql-powered endpoint inventory**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Querying endpoint state for asset inventory, compliance, and threat-hunting investigations.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[osquery]
...
* Focused workflow for sql-powered endpoint inventory.
...
osquery cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Velociraptor | A related workflow or comparison point | Verify upstream | Verify upstream |
| Wazuh | Complementary analysis | Verify upstream | Verify upstream |
| Fleet | Validation or defense | Verify upstream | Verify upstream |
...
Use osquery when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [osquery official repository](https://github.com/osquery/osquery)
2. [osquery official website](https://osquery.io/)
