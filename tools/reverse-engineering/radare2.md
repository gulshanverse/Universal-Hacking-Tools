...
official_website: https://rada.re/n/
documentation: https://book.rada.re/
security_domains: [Reverse Engineering, Binary analysis]
dual_use: true
...
sources:
  official_repository: https://github.com/radareorg/radare2
  official_website: https://rada.re/n/
  official_documentation: https://book.rada.re/
status: Verify against upstream documentation.
---

# Radare2

> Command-line reverse engineering. This page is written for lawful, authorized security education.

## Overview

**Radare2** is used for inspecting executable structure, control flow, and data with a scriptable analysis toolkit. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Reverse Engineering |
| Subcategory | Binary analysis |
| Primary purpose | Command-line reverse engineering |
| License | LGPL-3.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | C |
| Repository | [Radare2 repository](https://github.com/radareorg/radare2) |
| Official website | [https://rada.re/n/](https://rada.re/n/) |
| Documentation | [https://book.rada.re/](https://book.rada.re/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Advanced |
| Security domain | Reverse Engineering; Binary analysis |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Radare2 when the assessment question matches **command-line reverse engineering**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Inspecting executable structure, control flow, and data with a scriptable analysis toolkit.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Radare2]
...
* Focused workflow for command-line reverse engineering.
...
Radare2 cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| Cutter | Complementary analysis | Verify upstream | Verify upstream |
| LLDB | Validation or defense | Verify upstream | Verify upstream |
...
Use Radare2 when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Radare2 official repository](https://github.com/radareorg/radare2)
2. [Radare2 official website](https://rada.re/n/)
3. [Radare2 official documentation](https://book.rada.re/)
