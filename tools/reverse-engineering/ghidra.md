...
subcategory: Software reverse engineering
...
> Static binary analysis. This page is written for lawful, authorized security education.

## Overview

**Ghidra** is used for disassembly, decompilation, and collaborative analysis of software in a safe research environment. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Reverse Engineering |
| Subcategory | Software reverse engineering |
| Primary purpose | Static binary analysis |
| License | Apache-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | Java; C++ |
| Repository | [Ghidra repository](https://github.com/NationalSecurityAgency/ghidra) |
| Official website | [https://ghidra-sre.org/](https://ghidra-sre.org/) |
| Documentation | [https://ghidra.re/ghidra_docs/](https://ghidra.re/ghidra_docs/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Reverse Engineering; Software reverse engineering |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Ghidra when the assessment question matches **static binary analysis**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Disassembly, decompilation, and collaborative analysis of software in a safe research environment.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Ghidra]
...
* Focused workflow for static binary analysis.
...
Ghidra cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Radare2 | A related workflow or comparison point | Verify upstream | Verify upstream |
...
Use Ghidra when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Ghidra official repository](https://github.com/NationalSecurityAgency/ghidra)
2. [Ghidra official website](https://ghidra-sre.org/)
3. [Ghidra official documentation](https://ghidra.re/ghidra_docs/)
