...
sources:
  official_repository: https://github.com/zeek/zeek
  official_website: https://zeek.org/
  official_documentation: https://docs.zeek.org/
status: Verify against upstream documentation.
---

# Zeek

> Network telemetry and analysis. This page is written for lawful, authorized security education.

## Overview

**Zeek** is used for transforming network activity into structured logs and protocol-aware observations. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Network Security |
| Subcategory | Network security monitoring |
| Primary purpose | Network telemetry and analysis |
| License | BSD-3-Clause |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; macOS |
| Language | C++; Zeek script |
| Repository | [Zeek repository](https://github.com/zeek/zeek) |
| Official website | [https://zeek.org/](https://zeek.org/) |
| Documentation | [https://docs.zeek.org/](https://docs.zeek.org/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Advanced |
| Security domain | Network Security; Network security monitoring |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Zeek when the assessment question matches **network telemetry and analysis**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Transforming network activity into structured logs and protocol-aware observations.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Zeek]
...
* Focused workflow for network telemetry and analysis.
...
Zeek cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Suricata | A related workflow or comparison point | Verify upstream | Verify upstream |
| Security Onion | Complementary analysis | Verify upstream | Verify upstream |
| Arkime | Validation or defense | Verify upstream | Verify upstream |
...
Use Zeek when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Zeek official repository](https://github.com/zeek/zeek)
2. [Zeek official website](https://zeek.org/)
3. [Zeek official documentation](https://docs.zeek.org/)
