...
> Network threat detection. This page is written for lawful, authorized security education.

## Overview

**Suricata** is used for signature and protocol-aware detection with packet capture and json event output. Its value depends on clear authorization, a defined scope, and a documented assessment objective. It should be treated as one component of a broader workflow rather than as proof that a finding is exploitable or material.
...
| Category | Network Security |
| Subcategory | IDS/IPS and NSM |
| Primary purpose | Network threat detection |
| License | GPL-2.0 |
| Open source | Verify upstream; edition and component terms may differ. |
| Platform | Linux; Windows; macOS |
| Language | C |
| Repository | [Suricata repository](https://github.com/OISF/suricata) |
| Official website | [https://suricata.io/](https://suricata.io/) |
| Documentation | [https://docs.suricata.io/](https://docs.suricata.io/) |
| Current version | Not recorded here; verify upstream. |
| Difficulty | Intermediate |
| Security domain | Network Security; IDS/IPS and NSM |
| Defensive / offensive / both | Both; use only within authorization. |

## Purpose

Use Suricata when the assessment question matches **network threat detection**. A professional workflow normally records the asset or artifact, authorization, time window, operator, configuration, result, confidence, and remediation owner.

## Key Features

* Signature and protocol-aware detection with packet capture and JSON event output.
...
```mermaid
flowchart LR
    A[Authorized scope or artifact] --> B[Suricata]
...
* Focused workflow for network threat detection.
...
Suricata cannot replace authorization, asset ownership, threat modeling, manual validation, secure coding review, incident-response judgment, or remediation verification. It does not establish attribution or business impact by itself.
...
| --- | --- | --- | --- |
| Snort | A related workflow or comparison point | Verify upstream | Verify upstream |
...
Use Suricata when the objective is clearly defined, the data or target is authorized, the expected output is understood, and a reviewer can reproduce the observation.
...
1. [Suricata official repository](https://github.com/OISF/suricata)
2. [Suricata official website](https://suricata.io/)
3. [Suricata official documentation](https://docs.suricata.io/)
