...
> Defensive knowledge page for understanding, detecting, and mitigating api security weaknesses.

## Description

An API exposes data or operations without adequate authentication, authorization, validation, or resource controls.
...
Apply object-level authorization, schema validation, rate limits, inventory, and secure logging.
...
[OWASP API Top 10](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
