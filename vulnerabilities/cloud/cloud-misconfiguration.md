...
> Defensive knowledge page for understanding, detecting, and mitigating cloud misconfiguration.

## Description

Cloud resources, identity, or network controls are configured more broadly than intended.
...
Use least privilege, organization policies, private defaults, audit logs, and continuous posture checks.
...
[CWE-16](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
