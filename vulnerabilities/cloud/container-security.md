...
> Defensive knowledge page for understanding, detecting, and mitigating container security issues.

## Description

Container images, runtime privileges, orchestration, or supply-chain controls are insufficient.
...
Use minimal signed images, non-root execution, admission policy, patching, and runtime monitoring.
...
[CWE-250](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
