...
> Defensive knowledge page for understanding, detecting, and mitigating insecure direct object reference.

## Description

An object identifier is accepted without an authorization decision for the current principal.
...
Enforce server-side object-level authorization and test access-control matrices.
...
[CWE-639](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
