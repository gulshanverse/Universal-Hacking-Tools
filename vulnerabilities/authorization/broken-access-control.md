...
> Defensive knowledge page for understanding, detecting, and mitigating broken access control.

## Description

A system fails to enforce intended permissions consistently.
...
Centralize authorization, deny by default, verify server-side, and audit sensitive actions.
...
[CWE-862](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
