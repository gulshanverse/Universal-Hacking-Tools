...
> Defensive knowledge page for untrusted input influences the location of a file that the application includes or interprets.

## Description

Untrusted input influences the location of a file that the application includes or interprets. Assess the concrete implementation and trust boundary; the class name alone does not prove exploitability.
...
Potentially affected technologies include Http, Php. Verify the implementation and version before assigning a finding.
...
[CWE-98](https://cwe.mitre.org/) — verify the precise mapping for the implementation under review.
...
* [File Inclusion source](https://cwe.mitre.org/data/definitions/98.html)
