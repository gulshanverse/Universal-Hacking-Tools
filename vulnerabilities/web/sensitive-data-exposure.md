...
> Defensive knowledge page for understanding, detecting, and mitigating sensitive data exposure.

## Description

Information is disclosed to parties or contexts that do not need it.
...
Minimize collection, classify data, restrict access, redact logs, and encrypt where appropriate.
...
[CWE-200](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
