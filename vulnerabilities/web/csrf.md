...
A state-changing request can be induced without proving user intent.
...
Use anti-CSRF tokens, SameSite cookies, origin checks, and re-authentication for sensitive actions.
...
[CWE-352](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
