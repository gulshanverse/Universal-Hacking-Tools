...
> Defensive knowledge page for understanding, detecting, and mitigating xml external entity.

## Description

Unsafe XML processing resolves external entities or related constructs.
...
Disable external entity resolution and use hardened parsers with safe defaults.
...
[CWE-611](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
