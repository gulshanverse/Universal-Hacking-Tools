...
> Defensive knowledge page for inconsistent parsing of http message boundaries can cause intermediaries to disagree about requests.

## Description

Inconsistent parsing of HTTP message boundaries can cause intermediaries to disagree about requests. Assess the concrete implementation and trust boundary; the class name alone does not prove exploitability.
...
[CWE-444](https://cwe.mitre.org/) — verify the precise mapping for the implementation under review.
...
* [HTTP Request Smuggling source](https://cwe.mitre.org/data/definitions/444.html)
