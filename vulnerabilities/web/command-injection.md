...
> Defensive knowledge page for understanding, detecting, and mitigating command injection.

## Description

Untrusted input reaches an operating-system command interpreter.
...
Avoid shells, use safe APIs, strict allowlists, least privilege, and isolated workers.
...
[CWE-78](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
