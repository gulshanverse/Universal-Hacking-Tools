...
An application accepts files without enforcing safe type, storage, and processing boundaries.
...
Validate content, store outside executable paths, rename safely, scan, and enforce authorization.
...
[CWE-434](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
