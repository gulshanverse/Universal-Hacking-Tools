...
> Defensive knowledge page for untrusted input changes object prototypes in a way that affects application behavior.

## Description

Untrusted input changes object prototypes in a way that affects application behavior. Assess the concrete implementation and trust boundary; the class name alone does not prove exploitability.
...
Potentially affected technologies include Nodejs, Javascript. Verify the implementation and version before assigning a finding.
...
[CWE-1321](https://cwe.mitre.org/) — verify the precise mapping for the implementation under review.
...
* [Prototype Pollution source](https://cwe.mitre.org/data/definitions/1321.html)
