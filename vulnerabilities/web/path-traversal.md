...
> Defensive knowledge page for understanding, detecting, and mitigating path traversal.

## Description

Input changes a file path so that access escapes the intended directory.
...
Canonicalize safely, use object identifiers, enforce directory boundaries, and minimize file privileges.
...
[CWE-22](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
