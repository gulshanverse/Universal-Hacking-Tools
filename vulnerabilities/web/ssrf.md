...
> Defensive knowledge page for understanding, detecting, and mitigating server-side request forgery.

## Description

A server makes requests influenced by an attacker-controlled destination.
...
Use allowlists, egress controls, metadata-service protections, URL parsing, and network segmentation.
...
[CWE-918](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
