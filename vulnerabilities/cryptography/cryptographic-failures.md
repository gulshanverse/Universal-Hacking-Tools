...
> Defensive knowledge page for understanding, detecting, and mitigating cryptographic failures.

## Description

Sensitive data is insufficiently protected by cryptographic design or implementation.
...
Use current, reviewed primitives, sound key management, TLS, and data minimization.
...
[CWE-327](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
