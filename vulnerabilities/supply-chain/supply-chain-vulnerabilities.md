...
> Defensive knowledge page for understanding, detecting, and mitigating supply-chain vulnerabilities.

## Description

A dependency, build input, or delivery process introduces untrusted or vulnerable behavior.
...
Pin and verify dependencies, generate SBOMs, sign artifacts, and protect CI/CD identities.
...
[CWE-1357](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
