...
> Defensive knowledge page for understanding, detecting, and mitigating session management weaknesses.

## Description

Session identifiers or lifecycle controls permit unintended reuse or exposure.
...
Rotate identifiers, set secure cookie attributes, expire sessions, and invalidate on risk events.
...
[CWE-384](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
