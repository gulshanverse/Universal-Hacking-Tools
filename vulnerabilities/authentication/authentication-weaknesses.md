...
> Defensive knowledge page for understanding, detecting, and mitigating authentication weaknesses.

## Description

Identity proofing or authentication controls do not provide the intended assurance.
...
Use phishing-resistant MFA where appropriate, rate limits, secure recovery, and strong session handling.
...
[CWE-287](https://cwe.mitre.org/) — verify the exact mapping for the implementation under review.
