...
Build an access-control matrix and test object-level authorization using synthetic users and objects.
...
Local test API; two or more synthetic roles. Keep the environment isolated from production and unrelated networks.
