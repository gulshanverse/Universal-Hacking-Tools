...
Review a disposable cluster against configuration and least-privilege expectations.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. Kubescape or kube-bench; a non-production cluster.

## Environment

Kubescape or kube-bench; a non-production cluster. Keep it separate from production and unrelated networks.
