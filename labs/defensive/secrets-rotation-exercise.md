...
Detect a synthetic secret, rotate it, and verify that history and logs are handled safely.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. Gitleaks; a disposable Git repository.

## Environment

Gitleaks; a disposable Git repository. Keep it separate from production and unrelated networks.
