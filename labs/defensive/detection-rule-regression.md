...
Test a Sigma rule against synthetic logs and measure false positives.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. Sigma; local sample logs.

## Environment

Sigma; local sample logs. Keep it separate from production and unrelated networks.
