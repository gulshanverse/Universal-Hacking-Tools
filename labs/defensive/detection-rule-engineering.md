...
Write and test a vendor-neutral detection rule against synthetic logs and measure false positives.
...
Sigma; sample logs; local test harness. Keep the environment isolated from production and unrelated networks.
