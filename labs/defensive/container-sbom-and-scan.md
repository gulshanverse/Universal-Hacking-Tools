...
Generate an SBOM and interpret vulnerability findings for a disposable image.
...
Syft; Grype or Trivy; non-production image. Keep the environment isolated from production and unrelated networks.
