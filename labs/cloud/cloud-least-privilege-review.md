---
id: cloud-least-privilege-review
type: lab
...
# Cloud Least-Privilege Review

> Controlled, authorized lab exercise.

## Objective

Inspect a sandbox cloud account’s identity and storage posture without accessing unrelated data.
...
Disposable cloud sandbox; read-only role; budget and cleanup plan. Keep the environment isolated from production and unrelated networks.
