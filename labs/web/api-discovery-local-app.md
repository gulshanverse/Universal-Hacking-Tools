...
# API Discovery in a Local App

> Controlled, authorized lab exercise.

## Objective

Map documented and observed API routes in a local application.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. HTTPie or OWASP ZAP; a local test API.

## Environment

HTTPie or OWASP ZAP; a local test API. Keep it separate from production and unrelated networks.
