...
# SQL Injection Concepts in a Lab

> Controlled, authorized lab exercise.

## Objective

Understand unsafe query construction and verify the effect of parameterized queries in a deliberately vulnerable application.
...
Local training application; code access; no external target. Keep the environment isolated from production and unrelated networks.
