...
Trace requests, responses, cookies, and headers in a local application.
...
OWASP Juice Shop or WebGoat; OWASP ZAP. Keep the environment isolated from production and unrelated networks.
