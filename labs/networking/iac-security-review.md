...
Find insecure infrastructure-as-code defaults before deployment.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. KICS or Checkov; disposable fixture files.

## Environment

KICS or Checkov; disposable fixture files. Keep it separate from production and unrelated networks.
