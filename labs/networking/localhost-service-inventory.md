...
Map a local test service and interpret the difference between an open port and a confirmed service.
...
Nmap; a local VM or container. Keep the environment isolated from production and unrelated networks.
