...
Inspect certificate identity and transport configuration in a local service.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. testssl.sh; a local HTTPS service.

## Environment

testssl.sh; a local HTTPS service. Keep it separate from production and unrelated networks.
