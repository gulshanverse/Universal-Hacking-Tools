---
id: memory-analysis-fundamentals
type: lab
...
Analyze a known training memory image and distinguish observations from hypotheses.
...
Volatility 3; a training memory image; isolated workstation. Keep the environment isolated from production and unrelated networks.
