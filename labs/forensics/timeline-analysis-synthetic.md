---
id: timeline-analysis-synthetic
type: lab
...
# Timeline Analysis with Synthetic Artifacts

> Controlled, authorized lab exercise.

## Objective

Correlate file and event timestamps without using personal or production data.
...
Permission to use every system and dataset, a disposable environment, and the ability to reset it. Autopsy or a synthetic artifact set.

## Environment

Autopsy or a synthetic artifact set. Keep it separate from production and unrelated networks.
