...
3. Web and API fundamentals
4. Safe validation
5. Evidence and responsible disclosure

## Tools

* [Subfinder](../../tools/reconnaissance/subfinder.md)
* [Amass](../../tools/reconnaissance/amass.md)
...
Build a defensible understanding of bug bounty learning through concepts, controlled practice, evidence, detection, mitigation, and remediation verification.
