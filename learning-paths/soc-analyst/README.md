...
1. Alert triage
2. Windows and Linux logs
3. Network evidence
4. Identity events
5. Case notes and escalation
...
* [Sigma](../../tools/defensive-security/sigma.md)
...
Build a defensible understanding of soc analyst through concepts, controlled practice, evidence, detection, mitigation, and remediation verification.
