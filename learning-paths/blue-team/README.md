...
* [Suricata](../../tools/network-analysis/suricata.md)
...
Build a defensible understanding of blue team through concepts, controlled practice, evidence, detection, mitigation, and remediation verification.
