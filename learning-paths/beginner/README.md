...
3. TCP/IP, DNS, and HTTP
4. Authentication and cryptography basics
5. Security concepts and risk
6. Safe use of introductory tools
...
* [ExifTool](../../tools/osint/exiftool.md)
...
Build a defensible understanding of beginner cybersecurity through concepts, controlled practice, evidence, detection, mitigation, and remediation verification.
